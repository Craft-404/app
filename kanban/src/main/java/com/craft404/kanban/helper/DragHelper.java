package com.craft404.kanban.helper;
...
public class DragHelper {
    ...
    public void dragCol(View columnView, int position) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            ...
            if (holder != null && holder.getItemViewType() == TYPE_CONTENT) {
