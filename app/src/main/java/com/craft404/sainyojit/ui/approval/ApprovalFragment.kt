...
import com.craft404.sainyojit.ui.task.TaskCalendarFragment
import com.craft404.sainyojit.ui.task.TaskViewModel
import com.google.android.material.tabs.TabLayoutMediator
import com.google.android.material.textview.MaterialTextView
import java.util.*

class ApprovalFragment : CoreSainyojitFragment() {
    ...
    private fun createViewPagerAdapter(items: List<Date>): RecyclerView.Adapter<*> {
        return object : FragmentStateAdapter(this) {
            override fun createFragment(position: Int): ApprovalCalendarFragment {
                val item = items[position]
                return ApprovalCalendarFragment.newInstance(item)
            }
